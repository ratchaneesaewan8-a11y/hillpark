...
export const TOURS: Tour[] = [
  ...
  },
  {
    id: "t4",
    category_id: "atv",
    title_th: "ผจญภัยขับ ATV ชมวิวธรรมชาติ",
    title_en: "ATV Nature View Point Adventure",
    slug: "atv-nature-view-point-adventure",
    description_th:
    ...
    description_en: null,
    location: "กระบี่",
    cover_image: "https://images.unsplash.com/photo-1567789884554-0b844b597180?w=800&q=75",
    duration: "30-60 นาที (เลือกรอบได้)",
    start_time: null,
    end_time: null,
    pickup_available: true,
    pickup_info: "มีบริการรับส่งฟรีจากโรงแรมในพื้นที่ (ตามเงื่อนไข)",
    meeting_point: "จุดนัดพบ ATV กระบี่ (แจ้งพิกัดหลังจอง)",
    rating: 5.0,
    review_count: 23,
    base_price: 1100,
    featured: true,
